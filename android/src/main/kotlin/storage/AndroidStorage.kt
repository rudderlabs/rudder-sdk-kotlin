...
import com.rudderstack.android.sharedPrefs.SharedPrefsStore
import com.rudderstack.core.internals.storage.EventsFileManager
...
class AndroidStorage(context: Context, private val writeKey: String) : Storage {
    ...
    private val eventsFile = EventsFileManager(storageDirectory, writeKey, rudderPrefsRepo)
